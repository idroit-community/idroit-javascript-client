...
/**
 * The AllOfDidInfoCreatedBy model module.
 * @module model/AllOfDidInfoCreatedBy
 * @version 0.9.2
 */
export default class AllOfDidInfoCreatedBy extends User {
  /**
   * Constructs a new <code>AllOfDidInfoCreatedBy</code>.
   * (任意) DIDを生成したユーザーアカウント
   * @alias module:model/AllOfDidInfoCreatedBy
   * @class
  ...
  /**
   * Constructs a <code>AllOfDidInfoCreatedBy</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AllOfDidInfoCreatedBy} obj Optional instance to populate.
   * @return {module:model/AllOfDidInfoCreatedBy} The populated <code>AllOfDidInfoCreatedBy</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AllOfDidInfoCreatedBy();
