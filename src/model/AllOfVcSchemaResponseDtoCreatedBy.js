...
/**
 * The AllOfVcSchemaResponseDtoCreatedBy model module.
 * @module model/AllOfVcSchemaResponseDtoCreatedBy
 * @version 0.9.2
 */
export default class AllOfVcSchemaResponseDtoCreatedBy extends User {
  /**
   * Constructs a new <code>AllOfVcSchemaResponseDtoCreatedBy</code>.
   * VCスキーマを作成したユーザーアカウント
   * @alias module:model/AllOfVcSchemaResponseDtoCreatedBy
   * @class
  ...
  /**
   * Constructs a <code>AllOfVcSchemaResponseDtoCreatedBy</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AllOfVcSchemaResponseDtoCreatedBy} obj Optional instance to populate.
   * @return {module:model/AllOfVcSchemaResponseDtoCreatedBy} The populated <code>AllOfVcSchemaResponseDtoCreatedBy</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AllOfVcSchemaResponseDtoCreatedBy();
