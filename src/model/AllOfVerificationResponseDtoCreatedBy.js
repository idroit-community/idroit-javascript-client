...
/**
 * The AllOfVerificationResponseDtoCreatedBy model module.
 * @module model/AllOfVerificationResponseDtoCreatedBy
 * @version 0.9.2
 */
export default class AllOfVerificationResponseDtoCreatedBy extends User {
  /**
   * Constructs a new <code>AllOfVerificationResponseDtoCreatedBy</code>.
   * グループを作成したユーザーアカウント
   * @alias module:model/AllOfVerificationResponseDtoCreatedBy
   * @class
  ...
  /**
   * Constructs a <code>AllOfVerificationResponseDtoCreatedBy</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AllOfVerificationResponseDtoCreatedBy} obj Optional instance to populate.
   * @return {module:model/AllOfVerificationResponseDtoCreatedBy} The populated <code>AllOfVerificationResponseDtoCreatedBy</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AllOfVerificationResponseDtoCreatedBy();
