...
/**
 * The AllOfVcInfoCreatedBy model module.
 * @module model/AllOfVcInfoCreatedBy
 * @version 0.9.2
 */
export default class AllOfVcInfoCreatedBy extends User {
  /**
   * Constructs a new <code>AllOfVcInfoCreatedBy</code>.
   * (任意) VC情報を生成したユーザーアカウント
   * @alias module:model/AllOfVcInfoCreatedBy
   * @class
  ...
  /**
   * Constructs a <code>AllOfVcInfoCreatedBy</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AllOfVcInfoCreatedBy} obj Optional instance to populate.
   * @return {module:model/AllOfVcInfoCreatedBy} The populated <code>AllOfVcInfoCreatedBy</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AllOfVcInfoCreatedBy();
