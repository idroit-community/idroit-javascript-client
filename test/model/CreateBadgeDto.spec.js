...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateBadgeDto', function() {
      beforeEach(function() {
        instance = new IDroitDashboardAdminApi.CreateBadgeDto();
      });

      it('should create an instance of CreateBadgeDto', function() {
        // TODO: update the code to test CreateBadgeDto
        expect(instance).to.be.a(IDroitDashboardAdminApi.CreateBadgeDto);
      });
