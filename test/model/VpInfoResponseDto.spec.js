...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VpInfoResponseDto', function() {
      beforeEach(function() {
        instance = new IDroitDashboardAdminApi.VpInfoResponseDto();
      });

      it('should create an instance of VpInfoResponseDto', function() {
        // TODO: update the code to test VpInfoResponseDto
        expect(instance).to.be.a(IDroitDashboardAdminApi.VpInfoResponseDto);
      });
