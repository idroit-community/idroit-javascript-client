...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VcSchemasResponseDto', function() {
      beforeEach(function() {
        instance = new IDroitDashboardAdminApi.VcSchemasResponseDto();
      });

      it('should create an instance of VcSchemasResponseDto', function() {
        // TODO: update the code to test VcSchemasResponseDto
        expect(instance).to.be.a(IDroitDashboardAdminApi.VcSchemasResponseDto);
      });
