...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BadgeResponseDto', function() {
      beforeEach(function() {
        instance = new IDroitDashboardAdminApi.BadgeResponseDto();
      });

      it('should create an instance of BadgeResponseDto', function() {
        // TODO: update the code to test BadgeResponseDto
        expect(instance).to.be.a(IDroitDashboardAdminApi.BadgeResponseDto);
      });
