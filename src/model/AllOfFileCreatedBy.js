...
/**
 * The AllOfFileCreatedBy model module.
 * @module model/AllOfFileCreatedBy
 * @version 0.9.2
 */
export default class AllOfFileCreatedBy extends User {
  /**
   * Constructs a new <code>AllOfFileCreatedBy</code>.
   * (必須) ファイルをアップロードしたユーザーアカウント。
   * @alias module:model/AllOfFileCreatedBy
   * @class
  ...
  /**
   * Constructs a <code>AllOfFileCreatedBy</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AllOfFileCreatedBy} obj Optional instance to populate.
   * @return {module:model/AllOfFileCreatedBy} The populated <code>AllOfFileCreatedBy</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AllOfFileCreatedBy();
