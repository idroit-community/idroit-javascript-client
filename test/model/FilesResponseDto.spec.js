...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FilesResponseDto', function() {
      beforeEach(function() {
        instance = new IDroitDashboardAdminApi.FilesResponseDto();
      });

      it('should create an instance of FilesResponseDto', function() {
        // TODO: update the code to test FilesResponseDto
        expect(instance).to.be.a(IDroitDashboardAdminApi.FilesResponseDto);
      });
