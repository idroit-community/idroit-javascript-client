...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('IssueVcInfoDto', function() {
      beforeEach(function() {
        instance = new IDroitDashboardAdminApi.IssueVcInfoDto();
      });

      it('should create an instance of IssueVcInfoDto', function() {
        // TODO: update the code to test IssueVcInfoDto
        expect(instance).to.be.a(IDroitDashboardAdminApi.IssueVcInfoDto);
      });
