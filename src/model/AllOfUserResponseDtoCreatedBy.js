...
/**
 * The AllOfUserResponseDtoCreatedBy model module.
 * @module model/AllOfUserResponseDtoCreatedBy
 * @version 0.9.2
 */
export default class AllOfUserResponseDtoCreatedBy extends User {
  /**
   * Constructs a new <code>AllOfUserResponseDtoCreatedBy</code>.
   * ユーザーアカウントを作成したユーザーアカウント
   * @alias module:model/AllOfUserResponseDtoCreatedBy
   * @class
  ...
  /**
   * Constructs a <code>AllOfUserResponseDtoCreatedBy</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AllOfUserResponseDtoCreatedBy} obj Optional instance to populate.
   * @return {module:model/AllOfUserResponseDtoCreatedBy} The populated <code>AllOfUserResponseDtoCreatedBy</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AllOfUserResponseDtoCreatedBy();
