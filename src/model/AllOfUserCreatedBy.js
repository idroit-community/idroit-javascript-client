...
/**
 * The AllOfUserCreatedBy model module.
 * @module model/AllOfUserCreatedBy
 * @version 0.9.2
 */
export default class AllOfUserCreatedBy extends User {
  /**
   * Constructs a new <code>AllOfUserCreatedBy</code>.
   * (任意) このアカウントを作成したユーザー
   * @alias module:model/AllOfUserCreatedBy
   * @class
  ...
  /**
   * Constructs a <code>AllOfUserCreatedBy</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AllOfUserCreatedBy} obj Optional instance to populate.
   * @return {module:model/AllOfUserCreatedBy} The populated <code>AllOfUserCreatedBy</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AllOfUserCreatedBy();
