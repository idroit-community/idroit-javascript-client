...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateVcInfoDto', function() {
      beforeEach(function() {
        instance = new IDroitDashboardAdminApi.CreateVcInfoDto();
      });

      it('should create an instance of CreateVcInfoDto', function() {
        // TODO: update the code to test CreateVcInfoDto
        expect(instance).to.be.a(IDroitDashboardAdminApi.CreateVcInfoDto);
      });
      ...
      it('should have the property vcSchemaId (base name: "vcSchemaId")', function() {
        // TODO: update the code to test the property vcSchemaId
        expect(instance).to.have.property('vcSchemaId');
        // expect(instance.vcSchemaId).to.be(expectedValueLiteral);
      });
