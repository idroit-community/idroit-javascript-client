...
/**
 * The AllOfVpInfoCreatedBy model module.
 * @module model/AllOfVpInfoCreatedBy
 * @version 0.9.2
 */
export default class AllOfVpInfoCreatedBy extends User {
  /**
   * Constructs a new <code>AllOfVpInfoCreatedBy</code>.
   * (任意) VP情報を生成したユーザーアカウント
   * @alias module:model/AllOfVpInfoCreatedBy
   * @class
  ...
  /**
   * Constructs a <code>AllOfVpInfoCreatedBy</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AllOfVpInfoCreatedBy} obj Optional instance to populate.
   * @return {module:model/AllOfVpInfoCreatedBy} The populated <code>AllOfVpInfoCreatedBy</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AllOfVpInfoCreatedBy();
