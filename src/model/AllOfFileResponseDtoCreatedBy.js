...
/**
 * The AllOfFileResponseDtoCreatedBy model module.
 * @module model/AllOfFileResponseDtoCreatedBy
 * @version 0.9.2
 */
export default class AllOfFileResponseDtoCreatedBy extends User {
  /**
   * Constructs a new <code>AllOfFileResponseDtoCreatedBy</code>.
   * ファイルをアップロードしたユーザーアカウント
   * @alias module:model/AllOfFileResponseDtoCreatedBy
   * @class
  ...
  /**
   * Constructs a <code>AllOfFileResponseDtoCreatedBy</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AllOfFileResponseDtoCreatedBy} obj Optional instance to populate.
   * @return {module:model/AllOfFileResponseDtoCreatedBy} The populated <code>AllOfFileResponseDtoCreatedBy</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AllOfFileResponseDtoCreatedBy();
