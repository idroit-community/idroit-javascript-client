...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DidInfosResponseDto', function() {
      beforeEach(function() {
        instance = new IDroitDashboardAdminApi.DidInfosResponseDto();
      });

      it('should create an instance of DidInfosResponseDto', function() {
        // TODO: update the code to test DidInfosResponseDto
        expect(instance).to.be.a(IDroitDashboardAdminApi.DidInfosResponseDto);
      });
