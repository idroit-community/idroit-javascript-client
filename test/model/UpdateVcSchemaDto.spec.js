...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateVcSchemaDto', function() {
      beforeEach(function() {
        instance = new IDroitDashboardAdminApi.UpdateVcSchemaDto();
      });

      it('should create an instance of UpdateVcSchemaDto', function() {
        // TODO: update the code to test UpdateVcSchemaDto
        expect(instance).to.be.a(IDroitDashboardAdminApi.UpdateVcSchemaDto);
      });
