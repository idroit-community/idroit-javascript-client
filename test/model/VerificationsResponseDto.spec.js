...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VerificationsResponseDto', function() {
      beforeEach(function() {
        instance = new IDroitDashboardAdminApi.VerificationsResponseDto();
      });

      it('should create an instance of VerificationsResponseDto', function() {
        // TODO: update the code to test VerificationsResponseDto
        expect(instance).to.be.a(IDroitDashboardAdminApi.VerificationsResponseDto);
      });
