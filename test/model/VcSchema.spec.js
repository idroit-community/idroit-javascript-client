...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VcSchema', function() {
      beforeEach(function() {
        instance = new IDroitDashboardAdminApi.VcSchema();
      });

      it('should create an instance of VcSchema', function() {
        // TODO: update the code to test VcSchema
        expect(instance).to.be.a(IDroitDashboardAdminApi.VcSchema);
      });
