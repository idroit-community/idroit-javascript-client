...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MetaDto', function() {
      beforeEach(function() {
        instance = new IDroitDashboardAdminApi.MetaDto();
      });

      it('should create an instance of MetaDto', function() {
        // TODO: update the code to test MetaDto
        expect(instance).to.be.a(IDroitDashboardAdminApi.MetaDto);
      });
      ...
      it('should have the property itemsPerPage (base name: "itemsPerPage")', function() {
        // TODO: update the code to test the property itemsPerPage
        expect(instance).to.have.property('itemsPerPage');
        // expect(instance.itemsPerPage).to.be(expectedValueLiteral);
      });
