...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VerifiyBadgeFileReponseDto', function() {
      beforeEach(function() {
        instance = new IDroitDashboardAdminApi.VerifiyBadgeFileReponseDto();
      });

      it('should create an instance of VerifiyBadgeFileReponseDto', function() {
        // TODO: update the code to test VerifiyBadgeFileReponseDto
        expect(instance).to.be.a(IDroitDashboardAdminApi.VerifiyBadgeFileReponseDto);
      });
