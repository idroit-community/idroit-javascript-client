...
/**
 * The AllOfDidInfoUser model module.
 * @module model/AllOfDidInfoUser
 * @version 0.9.2
 */
export default class AllOfDidInfoUser extends User {
  /**
   * Constructs a new <code>AllOfDidInfoUser</code>.
   * (任意) DID情報に紐付いたアカウントの配列
   * @alias module:model/AllOfDidInfoUser
   * @class
  ...
  /**
   * Constructs a <code>AllOfDidInfoUser</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AllOfDidInfoUser} obj Optional instance to populate.
   * @return {module:model/AllOfDidInfoUser} The populated <code>AllOfDidInfoUser</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AllOfDidInfoUser();
