...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VpInfo', function() {
      beforeEach(function() {
        instance = new IDroitDashboardAdminApi.VpInfo();
      });

      it('should create an instance of VpInfo', function() {
        // TODO: update the code to test VpInfo
        expect(instance).to.be.a(IDroitDashboardAdminApi.VpInfo);
      });
