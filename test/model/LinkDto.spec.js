...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('LinkDto', function() {
      beforeEach(function() {
        instance = new IDroitDashboardAdminApi.LinkDto();
      });

      it('should create an instance of LinkDto', function() {
        // TODO: update the code to test LinkDto
        expect(instance).to.be.a(IDroitDashboardAdminApi.LinkDto);
      });
