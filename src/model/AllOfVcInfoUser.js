...
/**
 * The AllOfVcInfoUser model module.
 * @module model/AllOfVcInfoUser
 * @version 0.9.2
 */
export default class AllOfVcInfoUser extends User {
  /**
   * Constructs a new <code>AllOfVcInfoUser</code>.
   * (任意) VC情報と紐付いたアカウント
   * @alias module:model/AllOfVcInfoUser
   * @class
  ...
  /**
   * Constructs a <code>AllOfVcInfoUser</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AllOfVcInfoUser} obj Optional instance to populate.
   * @return {module:model/AllOfVcInfoUser} The populated <code>AllOfVcInfoUser</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AllOfVcInfoUser();
