...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MailsResponseDto', function() {
      beforeEach(function() {
        instance = new IDroitDashboardAdminApi.MailsResponseDto();
      });

      it('should create an instance of MailsResponseDto', function() {
        // TODO: update the code to test MailsResponseDto
        expect(instance).to.be.a(IDroitDashboardAdminApi.MailsResponseDto);
      });
