...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SignInResponseDto', function() {
      beforeEach(function() {
        instance = new IDroitDashboardAdminApi.SignInResponseDto();
      });

      it('should create an instance of SignInResponseDto', function() {
        // TODO: update the code to test SignInResponseDto
        expect(instance).to.be.a(IDroitDashboardAdminApi.SignInResponseDto);
      });
