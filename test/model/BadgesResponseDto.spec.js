...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BadgesResponseDto', function() {
      beforeEach(function() {
        instance = new IDroitDashboardAdminApi.BadgesResponseDto();
      });

      it('should create an instance of BadgesResponseDto', function() {
        // TODO: update the code to test BadgesResponseDto
        expect(instance).to.be.a(IDroitDashboardAdminApi.BadgesResponseDto);
      });
