...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetProfileResponseDto', function() {
      beforeEach(function() {
        instance = new IDroitDashboardAdminApi.GetProfileResponseDto();
      });

      it('should create an instance of GetProfileResponseDto', function() {
        // TODO: update the code to test GetProfileResponseDto
        expect(instance).to.be.a(IDroitDashboardAdminApi.GetProfileResponseDto);
      });
