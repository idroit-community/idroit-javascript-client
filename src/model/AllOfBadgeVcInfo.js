...
/**
 * The AllOfBadgeVcInfo model module.
 * @module model/AllOfBadgeVcInfo
 * @version 0.9.2
 */
export default class AllOfBadgeVcInfo extends VcInfo {
  /**
   * Constructs a new <code>AllOfBadgeVcInfo</code>.
   * (任意) バッジに紐付き、メタデータとなるVC情報
   * @alias module:model/AllOfBadgeVcInfo
   * @class
  ...
  /**
   * Constructs a <code>AllOfBadgeVcInfo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AllOfBadgeVcInfo} obj Optional instance to populate.
   * @return {module:model/AllOfBadgeVcInfo} The populated <code>AllOfBadgeVcInfo</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AllOfBadgeVcInfo();
