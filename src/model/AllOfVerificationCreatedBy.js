...
/**
 * The AllOfVerificationCreatedBy model module.
 * @module model/AllOfVerificationCreatedBy
 * @version 0.9.2
 */
export default class AllOfVerificationCreatedBy extends User {
  /**
   * Constructs a new <code>AllOfVerificationCreatedBy</code>.
   * (任意) 検証結果を作成したユーザーアカウント
   * @alias module:model/AllOfVerificationCreatedBy
   * @class
  ...
  /**
   * Constructs a <code>AllOfVerificationCreatedBy</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AllOfVerificationCreatedBy} obj Optional instance to populate.
   * @return {module:model/AllOfVerificationCreatedBy} The populated <code>AllOfVerificationCreatedBy</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AllOfVerificationCreatedBy();
