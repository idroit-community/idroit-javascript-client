...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GroupResponseDto', function() {
      beforeEach(function() {
        instance = new IDroitDashboardAdminApi.GroupResponseDto();
      });

      it('should create an instance of GroupResponseDto', function() {
        // TODO: update the code to test GroupResponseDto
        expect(instance).to.be.a(IDroitDashboardAdminApi.GroupResponseDto);
      });
