...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VcSchemaResponseDto', function() {
      beforeEach(function() {
        instance = new IDroitDashboardAdminApi.VcSchemaResponseDto();
      });

      it('should create an instance of VcSchemaResponseDto', function() {
        // TODO: update the code to test VcSchemaResponseDto
        expect(instance).to.be.a(IDroitDashboardAdminApi.VcSchemaResponseDto);
      });
      ...
      it('should have the property vcContexts (base name: "vcContexts")', function() {
        // TODO: update the code to test the property vcContexts
        expect(instance).to.have.property('vcContexts');
        // expect(instance.vcContexts).to.be(expectedValueLiteral);
      });

      it('should have the property vcSchemaProperties (base name: "vcSchemaProperties")', function() {
        // TODO: update the code to test the property vcSchemaProperties
        expect(instance).to.have.property('vcSchemaProperties');
        // expect(instance.vcSchemaProperties).to.be(expectedValueLiteral);
      });
