...
/**
 * The AllOfGroupCreatedBy model module.
 * @module model/AllOfGroupCreatedBy
 * @version 0.9.2
 */
export default class AllOfGroupCreatedBy extends User {
  /**
   * Constructs a new <code>AllOfGroupCreatedBy</code>.
   * (必須) グループを作成したユーザーアカウント。
   * @alias module:model/AllOfGroupCreatedBy
   * @class
  ...
  /**
   * Constructs a <code>AllOfGroupCreatedBy</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AllOfGroupCreatedBy} obj Optional instance to populate.
   * @return {module:model/AllOfGroupCreatedBy} The populated <code>AllOfGroupCreatedBy</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AllOfGroupCreatedBy();
