...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VcInfosResponseDto', function() {
      beforeEach(function() {
        instance = new IDroitDashboardAdminApi.VcInfosResponseDto();
      });

      it('should create an instance of VcInfosResponseDto', function() {
        // TODO: update the code to test VcInfosResponseDto
        expect(instance).to.be.a(IDroitDashboardAdminApi.VcInfosResponseDto);
      });
