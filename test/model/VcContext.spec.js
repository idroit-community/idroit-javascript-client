...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VcContext', function() {
      beforeEach(function() {
        instance = new IDroitDashboardAdminApi.VcContext();
      });

      it('should create an instance of VcContext', function() {
        // TODO: update the code to test VcContext
        expect(instance).to.be.a(IDroitDashboardAdminApi.VcContext);
      });
