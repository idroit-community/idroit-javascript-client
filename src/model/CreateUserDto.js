...
export default class CreateUserDto {
   ...
   * @class
   * @param name {String} (必須) ユーザーアカウントの名前
   * @param email {String} (必須) ユーザーアカウントのメールアドレス
   * @param role {String} (必須) アカウントのタイプ
   */
 ...
 */
CreateUserDto.prototype.needActivateFlow = undefined;

/**
 * (任意) ユーザーアカウントに紐付けるグループのIDの配列
 * @member {Array.<String>} groupIds
 */
CreateUserDto.prototype.groupIds = undefined;
