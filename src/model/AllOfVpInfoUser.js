...
/**
 * The AllOfVpInfoUser model module.
 * @module model/AllOfVpInfoUser
 * @version 0.9.2
 */
export default class AllOfVpInfoUser extends User {
  /**
   * Constructs a new <code>AllOfVpInfoUser</code>.
   * (任意) VP情報と紐付いたアカウント
   * @alias module:model/AllOfVpInfoUser
   * @class
  ...
  /**
   * Constructs a <code>AllOfVpInfoUser</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AllOfVpInfoUser} obj Optional instance to populate.
   * @return {module:model/AllOfVpInfoUser} The populated <code>AllOfVpInfoUser</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AllOfVpInfoUser();
