...
/**
 * The AllOfGroupResponseDtoCreatedBy model module.
 * @module model/AllOfGroupResponseDtoCreatedBy
 * @version 0.9.2
 */
export default class AllOfGroupResponseDtoCreatedBy extends User {
  /**
   * Constructs a new <code>AllOfGroupResponseDtoCreatedBy</code>.
   * グループを作成したユーザーアカウント
   * @alias module:model/AllOfGroupResponseDtoCreatedBy
   * @class
  ...
  /**
   * Constructs a <code>AllOfGroupResponseDtoCreatedBy</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AllOfGroupResponseDtoCreatedBy} obj Optional instance to populate.
   * @return {module:model/AllOfGroupResponseDtoCreatedBy} The populated <code>AllOfGroupResponseDtoCreatedBy</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AllOfGroupResponseDtoCreatedBy();
