...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GroupsResponseDto', function() {
      beforeEach(function() {
        instance = new IDroitDashboardAdminApi.GroupsResponseDto();
      });

      it('should create an instance of GroupsResponseDto', function() {
        // TODO: update the code to test GroupsResponseDto
        expect(instance).to.be.a(IDroitDashboardAdminApi.GroupsResponseDto);
      });
