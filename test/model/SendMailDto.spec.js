...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SendMailDto', function() {
      beforeEach(function() {
        instance = new IDroitDashboardAdminApi.SendMailDto();
      });

      it('should create an instance of SendMailDto', function() {
        // TODO: update the code to test SendMailDto
        expect(instance).to.be.a(IDroitDashboardAdminApi.SendMailDto);
      });
